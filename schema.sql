...
CREATE VIEW cowid_date_location AS
    SELECT DISTINCT gps_coord.cowid, gps_coord.date, btrim((gps_coord.lokalitet)::text) AS lokalitet FROM gps_coord;


ALTER TABLE public.cowid_date_location OWNER TO postgres;

--
-- Name: cowid_date_locatkon_old; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW cowid_date_locatkon_old AS
    SELECT DISTINCT gpspoint.cowid, (gpspoint.datetime)::date AS date, "substring"((gpspoint.lokalitet)::text, 0, 10) AS lokalitet FROM gpspoint;


ALTER TABLE public.cowid_date_locatkon_old OWNER TO postgres;

--
-- Name: cowlocation; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE cowlocation (
    cowid integer NOT NULL,
    location character varying NOT NULL
);


ALTER TABLE public.cowlocation OWNER TO postgres;
...
--
-- Name: geilo_cat; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW geilo_cat AS
    SELECT m.gid, m.objectid, m.user_id_po, m.marktype, m.felt_og_bu, m.fuktighets, m.busksjikt, m.dekning_bu, m.skogvegeta, m.dekning_tr, m.marktype_d, m.marktype_1, m.felt_og__1, m.felt_og__2, m.fuktighe_1, m.fuktighe_2, m.busksjikt_, m.busksjikt1, m.dekning__1, m.dekning__2, m.skogvege_1, m.skogvege_2, m.dekning__3, m.shape_leng, m.shape_area, m.the_geom, c.kombinert FROM ("Geilo_complete_31may2012_utm32_00" m LEFT JOIN geilo_category c ON (((((((((m.marktype)::text = (c.marktype)::text) AND ((m.felt_og_bu)::text = (c.felt_og_bu)::text)) AND ((m.fuktighets)::text = (c.fuktighets)::text)) AND ((m.busksjikt)::text = (c.busksjikt)::text)) AND ((m.dekning_bu)::text = (c.dekning_bu)::text)) AND ((m.skogvegeta)::text = (c.skogvegeta)::text)) AND ((m.dekning_tr)::text = (c.dekning_tr)::text))));


ALTER TABLE public.geilo_cat OWNER TO postgres;

--
-- Name: geilo_cat2; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW geilo_cat2 AS
    SELECT m.gid, m.objectid, m.user_id_po, m.marktype, m.felt_og_bu, m.fuktighets, m.busksjikt, m.dekning_bu, m.skogvegeta, m.dekning_tr, m.marktype_d, m.marktype_1, m.felt_og__1, m.felt_og__2, m.fuktighe_1, m.fuktighe_2, m.busksjikt_, m.busksjikt1, m.dekning__1, m.dekning__2, m.skogvege_1, m.skogvege_2, m.dekning__3, m.shape_leng, m.shape_area, m.the_geom, c.kombinert, c.categorycode AS code FROM ("Geilo_complete_31may2012_utm32_00" m LEFT JOIN geilo_category c ON (((((((((m.marktype)::text = (c.marktype)::text) AND ((m.felt_og_bu)::text = (c.felt_og_bu)::text)) AND ((m.fuktighets)::text = (c.fuktighets)::text)) AND ((m.busksjikt)::text = (c.busksjikt)::text)) AND ((m.dekning_bu)::text = (c.dekning_bu)::text)) AND ((m.skogvegeta)::text = (c.skogvegeta)::text)) AND ((m.dekning_tr)::text = (c.dekning_tr)::text))));


ALTER TABLE public.geilo_cat2 OWNER TO postgres;

--
-- Name: geilo_vegclasses; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE geilo_vegclasses (
    norsk character varying(255),
    engelsk character varying(255),
    id integer
);


ALTER TABLE public.geilo_vegclasses OWNER TO postgres;

--
-- Name: geilo_classified; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW geilo_classified AS
    SELECT m.gid, m.objectid, m.marktype, m.felt_og_bu, m.fuktighets, m.busksjikt, m.dekning_bu, m.skogvegeta, m.dekning_tr, m.marktype_d, m.marktype_1, m.felt_og__1, m.felt_og__2, m.fuktighe_1, m.fuktighe_2, m.busksjikt_, m.busksjikt1, m.dekning__1, m.dekning__2, m.skogvege_1, m.skogvege_2, m.dekning__3, m.shape_leng, m.shape_area, n.engelsk AS category, c.categorycode, m.the_geom FROM geilo_vegclasses n, ("Geilo_complete_31may2012_utm32_00" m LEFT JOIN geilo_category c ON (((((((((m.marktype)::text = (c.marktype)::text) AND ((m.felt_og_bu)::text = (c.felt_og_bu)::text)) AND ((m.fuktighets)::text = (c.fuktighets)::text)) AND ((m.busksjikt)::text = (c.busksjikt)::text)) AND ((m.dekning_bu)::text = (c.dekning_bu)::text)) AND ((m.skogvegeta)::text = (c.skogvegeta)::text)) AND ((m.dekning_tr)::text = (c.dekning_tr)::text)))) WHERE (c.categorycode = n.id);


ALTER TABLE public.geilo_classified OWNER TO postgres;
...
--
-- Name: geilo_poly_point_day; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW geilo_poly_point_day AS
    SELECT fly.gid, count(pnt.*) AS count, pnt.date FROM "Geilo_complete_31may2012_utm32_00" fly, geilo_points pnt WHERE st_contains(fly.the_geom, pnt.shape_utm) GROUP BY fly.gid, pnt.date;


ALTER TABLE public.geilo_poly_point_day OWNER TO postgres;

--
-- Name: geilo_cate_pr_day; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW geilo_cate_pr_day AS
    SELECT sum(pp.count) AS n, pp.date, cl.category FROM geilo_poly_point_day pp, geilo_classified cl WHERE (pp.gid = cl.gid) GROUP BY pp.date, cl.category;


ALTER TABLE public.geilo_cate_pr_day OWNER TO postgres;
...
--
-- Name: geilo_kategorisert; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW geilo_kategorisert AS
    SELECT m.gid, m.objectid, m.marktype, m.felt_og_bu, m.fuktighets, m.busksjikt, m.dekning_bu, m.skogvegeta, m.dekning_tr, m.marktype_d, m.marktype_1, m.felt_og__1, m.felt_og__2, m.fuktighe_1, m.fuktighe_2, m.busksjikt_, m.busksjikt1, m.dekning__1, m.dekning__2, m.skogvege_1, m.skogvege_2, m.dekning__3, m.shape_leng, m.shape_area, c.kombinert AS category, c.categorycode, m.the_geom FROM ("Geilo_complete_31may2012_utm32_00" m LEFT JOIN geilo_category c ON (((((((((m.marktype)::text = (c.marktype)::text) AND ((m.felt_og_bu)::text = (c.felt_og_bu)::text)) AND ((m.fuktighets)::text = (c.fuktighets)::text)) AND ((m.busksjikt)::text = (c.busksjikt)::text)) AND ((m.dekning_bu)::text = (c.dekning_bu)::text)) AND ((m.skogvegeta)::text = (c.skogvegeta)::text)) AND ((m.dekning_tr)::text = (c.dekning_tr)::text))));


ALTER TABLE public.geilo_kategorisert OWNER TO postgres;
...
CREATE TABLE observation (
    ...
    lokalitet character varying(20),
...
--
-- Name: geilo_pp_day; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW geilo_pp_day AS
    SELECT date_part('year'::text, pnt.datetime) AS year, date_part('month'::text, pnt.datetime) AS month, date_part('day'::text, pnt.datetime) AS day, fly.gid, count(pnt.*) AS count FROM "Geilo_complete_31may2012_utm32_00" fly, geilo_points pnt WHERE st_contains(fly.the_geom, pnt.shape_utm) GROUP BY fly.gid, date_part('year'::text, pnt.datetime), date_part('day'::text, pnt.datetime), date_part('month'::text, pnt.datetime);


ALTER TABLE public.geilo_pp_day OWNER TO postgres;

--
-- Name: geilo_summ_cats; Type: VIEW; Schema: public; Owner: postgres
--
...
--
-- Name: geilo_types; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW geilo_types AS
    SELECT "Geilo_complete_31may2012_utm32_00".gid, "Geilo_complete_31may2012_utm32_00".marktype, "Geilo_complete_31may2012_utm32_00".felt_og_bu, "Geilo_complete_31may2012_utm32_00".fuktighets, "Geilo_complete_31may2012_utm32_00".busksjikt, "Geilo_complete_31may2012_utm32_00".dekning_bu, "Geilo_complete_31may2012_utm32_00".skogvegeta, "Geilo_complete_31may2012_utm32_00".dekning_tr FROM "Geilo_complete_31may2012_utm32_00";


ALTER TABLE public.geilo_types OWNER TO postgres;
...
--
-- Name: gps_observation; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW gps_observation AS
    SELECT g.id, g.datetime, g.date, rtrim((g.lokalitet)::text) AS lokalitet, g.cowid, g.x, g.y, o.observation, o.obstype FROM (gps_coord g LEFT JOIN observation o ON ((o.gpspointid = g.id)));


ALTER TABLE public.gps_observation OWNER TO postgres;
...
--
-- Name: modelresult; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
CREATE SEQUENCE modelresults_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.modelresults_id_seq OWNER TO postgres;

--
-- Name: modelresults_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE modelresults_id_seq OWNED BY modelresult.id;


--
-- Name: modelrun; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE public.modelrun OWNER TO postgres;

--
-- Name: modelrun_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE modelrun_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.modelrun_id_seq OWNER TO postgres;

--
-- Name: modelrun_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE modelrun_id_seq OWNED BY modelrun.id;


--
-- Name: modelvalidation; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE modelvalidation (
    id integer NOT NULL,
    modelid integer,
    cowid integer,
    date date,
...
ALTER TABLE public.modelvalidation OWNER TO postgres;

--
-- Name: modeltotals; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW modeltotals AS
    SELECT modelvalidation.id, modelvalidation.modelid, modelvalidation.cowid, modelvalidation.date, modelvalidation.g2g, modelvalidation.w2w, modelvalidation.r2r, modelvalidation.g2w, modelvalidation.g2r, modelvalidation.w2g, modelvalidation.w2r, modelvalidation.r2g, modelvalidation.r2w, ((modelvalidation.g2g + modelvalidation.r2r) + modelvalidation.w2w) AS hit, (((((modelvalidation.g2w + modelvalidation.g2r) + modelvalidation.r2g) + modelvalidation.r2w) + modelvalidation.w2g) + modelvalidation.w2r) AS miss, ((((((((modelvalidation.g2w + modelvalidation.g2r) + modelvalidation.r2g) + modelvalidation.r2w) + modelvalidation.w2g) + modelvalidation.w2r) + modelvalidation.g2g) + modelvalidation.r2r) + modelvalidation.w2w) AS total FROM modelvalidation;


ALTER TABLE public.modeltotals OWNER TO postgres;

--
-- Name: modeltotalsum; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW modeltotalsum AS
    SELECT modeltotals.modelid, sum(modeltotals.hit) AS hit, sum(modeltotals.miss) AS miss, sum(modeltotals.total) AS total, sum(modeltotals.g2g) AS g2g, sum(modeltotals.w2w) AS w2w, sum(modeltotals.r2r) AS r2r, sum(modeltotals.g2w) AS g2w, sum(modeltotals.g2r) AS g2r, sum(modeltotals.w2g) AS w2g, sum(modeltotals.w2r) AS w2r, sum(modeltotals.r2g) AS r2g, sum(modeltotals.r2w) AS r2w, cowlocation.location FROM modeltotals, cowlocation WHERE (modeltotals.cowid = cowlocation.cowid) GROUP BY modeltotals.modelid, cowlocation.location;


ALTER TABLE public.modeltotalsum OWNER TO postgres;

--
-- Name: modelvalidation_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE modelvalidation_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.modelvalidation_id_seq OWNER TO postgres;

--
-- Name: modelvalidation_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE modelvalidation_id_seq OWNED BY modelvalidation.id;
...
--
-- Name: observationxy; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW observationxy AS
    SELECT observation.id, observation.observation, observation.observer, observation."timestamp", observation.gpsid, observation.gpspointid, observation.cowid, observation.addtime, observation.obstype, gpspoint.lokalitet, gpspoint.x, gpspoint.y FROM observation, gps_coord gpspoint WHERE (observation.gpspointid = gpspoint.id);


ALTER TABLE public.observationxy OWNER TO postgres;
...
--
-- Name: valdres_category; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE valdres_category (
    marktype character varying(8),
    felt_og_bu character varying(8),
    fuktighet character varying(8),
    busksjikt character varying(8),
    dekn_busk character varying(8),
    skogsvegetasjon character varying(8),
    dekning_tre character varying(8),
    kombinert character varying,
    id integer NOT NULL,
    categorycode integer
);
...
ALTER TABLE public.valdres_category OWNER TO postgres;

--
-- Name: valdres_vegclasses; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE valdres_vegclasses (
    norsk character varying(255),
...
ALTER TABLE public.valdres_vegclasses OWNER TO postgres;
...
--
-- Name: valdres_classified; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW valdres_classified AS
    SELECT t.gid, t.__gid, t.objectid, t.shape_leng, t.poly_id, t.busksjikt, t.busks_c, t.dekn_busk, t.busk_dek_c, t.dekn_tresj, t.dekn_tre_c, t.felt_bunn, t.felt_bun_c, t.fuktigh, t.fuktigh_c, t.skogvege, t.skogsveg_c, t.marktype, t.marktype_c, t.shape_le_1, t.shape_area, t.the_geom, n.engelsk AS category, c.categorycode FROM valdres_vegclasses n, (valdrestolkn t LEFT JOIN valdres_category c ON ((((((((((c.marktype)::text = (t.marktype_c)::text) OR ((c.marktype IS NULL) AND (t.marktype_c IS NULL))) AND (((c.felt_og_bu)::text = (t.felt_bun_c)::text) OR ((c.felt_og_bu IS NULL) AND (t.felt_bun_c IS NULL)))) AND (((c.fuktighet)::text = (t.fuktigh_c)::text) OR ((c.fuktighet IS NULL) AND (t.fuktigh_c IS NULL)))) AND (((c.busksjikt)::text = (t.busks_c)::text) OR ((c.busksjikt IS NULL) AND (t.busks_c IS NULL)))) AND (((c.dekn_busk)::text = (t.busk_dek_c)::text) OR ((c.dekn_busk IS NULL) AND (t.busk_dek_c IS NULL)))) AND (((c.skogsvegetasjon)::text = (t.skogsveg_c)::text) OR ((c.skogsvegetasjon IS NULL) AND (t.skogsveg_c IS NULL)))) AND (((c.dekning_tre)::text = (t.dekn_tre_c)::text) OR ((c.dekning_tre IS NULL) AND (t.dekn_tre_c IS NULL)))))) WHERE (c.categorycode = n.id);


ALTER TABLE public.valdres_classified OWNER TO postgres;
...
--
-- Name: valdres_poly_point_day; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW valdres_poly_point_day AS
    SELECT fly.gid, count(pnt.*) AS count, pnt.date FROM "Valdres_complete_03jun2012_utm32" fly, valdres_points pnt WHERE st_contains(fly.the_geom, pnt.shape_utm) GROUP BY fly.gid, pnt.date;


ALTER TABLE public.valdres_poly_point_day OWNER TO postgres;

--
-- Name: valdres_cate_pr_day; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW valdres_cate_pr_day AS
    SELECT sum(pp.count) AS n, pp.date, cl.category FROM valdres_poly_point_day pp, valdres_classified cl WHERE (pp.gid = cl.gid) GROUP BY pp.date, cl.category;


ALTER TABLE public.valdres_cate_pr_day OWNER TO postgres;

--
-- Name: valdres_category_code; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE valdres_category_code
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.valdres_category_code OWNER TO postgres;

--
-- Name: valdres_category_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE valdres_category_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.valdres_category_id_seq OWNER TO postgres;

--
-- Name: valdres_category_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE valdres_category_id_seq OWNED BY valdres_category.id;


--
-- Name: valdres_point_gid; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW valdres_point_gid AS
    SELECT fly.gid, pnt.id, pnt.datetime, pnt.date, pnt.lat, pnt.lon, pnt.cowid, pnt.lokalitet, pnt.shape_utm FROM "Valdres_complete_03jun2012_utm32" fly, valdres_points pnt WHERE st_contains(fly.the_geom, pnt.shape_utm);


ALTER TABLE public.valdres_point_gid OWNER TO postgres;
...
--
-- Name: valdres_classifiedgps; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW valdres_classifiedgps AS
    SELECT p.gid, p.id, p.datetime, p.date, x(p.shape_utm) AS x, y(p.shape_utm) AS y, p.cowid, p.lokalitet, c.category, c.categorycode FROM valdres_point_gid p, valdresclassified c WHERE (c.gid = p.gid);
...
--
-- Name: valdresveg; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW valdresveg AS
    SELECT "Valdres_complete_03jun2012_utm32".gid, "Valdres_complete_03jun2012_utm32".__gid, "Valdres_complete_03jun2012_utm32".objectid, "Valdres_complete_03jun2012_utm32".shape_leng, "Valdres_complete_03jun2012_utm32".poly_id, "Valdres_complete_03jun2012_utm32".busksjikt, "Valdres_complete_03jun2012_utm32".busks_c, "Valdres_complete_03jun2012_utm32".dekn_busk, "Valdres_complete_03jun2012_utm32".busk_dek_c, "Valdres_complete_03jun2012_utm32".dekn_tresj, "Valdres_complete_03jun2012_utm32".dekn_tre_c, "Valdres_complete_03jun2012_utm32".felt_bunn, "Valdres_complete_03jun2012_utm32".felt_bun_c, "Valdres_complete_03jun2012_utm32".fuktigh, "Valdres_complete_03jun2012_utm32".fuktigh_c, "Valdres_complete_03jun2012_utm32".skogvege, "Valdres_complete_03jun2012_utm32".skogsveg_c, "Valdres_complete_03jun2012_utm32".marktype, "Valdres_complete_03jun2012_utm32".marktype_c, "Valdres_complete_03jun2012_utm32".shape_le_1, "Valdres_complete_03jun2012_utm32".shape_area, "Valdres_complete_03jun2012_utm32".the_geom FROM "Valdres_complete_03jun2012_utm32";


ALTER TABLE public.valdresveg OWNER TO postgres;

--
-- Name: valdresclasses; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW valdresclasses AS
    SELECT valdresveg.busksjikt, "substring"((valdresveg.busks_c)::text, 1, 4) AS bs, valdresveg.dekn_busk, "substring"((valdresveg.busk_dek_c)::text, 1, 4) AS bd, valdresveg.dekn_tresj, "substring"((valdresveg.dekn_tre_c)::text, 1, 4) AS detr, valdresveg.felt_bunn, "substring"((valdresveg.felt_bun_c)::text, 1, 4) AS fb, valdresveg.fuktigh, "substring"((valdresveg.fuktigh_c)::text, 1, 4) AS fukt, valdresveg.skogvege, "substring"((valdresveg.skogsveg_c)::text, 1, 4) AS skog, valdresveg.marktype, "substring"((valdresveg.marktype_c)::text, 1, 4) AS mark FROM valdresveg;
...
ALTER TABLE ONLY modelresult ALTER COLUMN id SET DEFAULT nextval('modelresults_id_seq'::regclass);
...
ALTER TABLE ONLY modelrun ALTER COLUMN id SET DEFAULT nextval('modelrun_id_seq'::regclass);
...
ALTER TABLE ONLY modelvalidation ALTER COLUMN id SET DEFAULT nextval('modelvalidation_id_seq'::regclass);
...
ALTER TABLE ONLY valdres_category ALTER COLUMN id SET DEFAULT nextval('valdres_category_id_seq'::regclass);
...
--
-- Name: cowlocation_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY cowlocation
    ADD CONSTRAINT cowlocation_pkey PRIMARY KEY (cowid);
...
--
-- Name: modelresults_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY modelresult
    ADD CONSTRAINT modelresults_pkey PRIMARY KEY (id);


--
-- Name: modelrun_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY modelrun
    ADD CONSTRAINT modelrun_pkey PRIMARY KEY (id);


--
-- Name: modelvalidation_modelid_cowid_date_key; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY modelvalidation
    ADD CONSTRAINT modelvalidation_modelid_cowid_date_key UNIQUE (modelid, cowid, date);


--
-- Name: modelvalidation_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY modelvalidation
    ADD CONSTRAINT modelvalidation_pkey PRIMARY KEY (id);
...
--
-- Name: uniqueruns; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY modelrun
    ADD CONSTRAINT uniqueruns UNIQUE (restspeed, restratio, walkspeed, walkratio, walkspan, restspan, minutes, walktyp, resttyp);
...
--
-- Name: valdres_category_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY valdres_category
    ADD CONSTRAINT valdres_category_pkey PRIMARY KEY (id);
...
--
-- Name: modelresult_gpspointid_idx; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX modelresult_gpspointid_idx ON modelresult USING btree (gpspointid);


--
-- Name: modelresult_modelrunid_idx; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX modelresult_modelrunid_idx ON modelresult USING btree (modelrunid);


--
-- Name: modelresult_result_idx; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX modelresult_result_idx ON modelresult USING btree (result);
...
--
-- Name: modelresults_gpspointid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY modelresult
    ADD CONSTRAINT modelresults_gpspointid_fkey FOREIGN KEY (gpspointid) REFERENCES gpspoint(id);


--
-- Name: modelresults_modelrunid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY modelresult
    ADD CONSTRAINT modelresults_modelrunid_fkey FOREIGN KEY (modelrunid) REFERENCES modelrun(id);


--
-- Name: modelvalidation; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY modelvalidation
    ADD CONSTRAINT modelvalidation FOREIGN KEY (modelid) REFERENCES modelrun(id);
